# THEOplayer iOS Reference Apps - THEO Custom Ads

The purpose of this app is to demonstrate how a configurable ads app with Google IMA can be made with [THEOplayer].

## Getting Started

* Obtain THEOplayer SDK with Google IMA feature enabled. If you don't have a SDK yet, please visit [Get Started with THEOplayer].
