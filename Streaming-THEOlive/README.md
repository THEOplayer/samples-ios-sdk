...
2. Add the `THEOplayerSDK` and `THEOplayerTHEOliveIntegration` to your project.
...
[Getting started with THEOlive for iOS]: https://optiview.dolby.com/docs/theolive/playback/ios/getting-started/
