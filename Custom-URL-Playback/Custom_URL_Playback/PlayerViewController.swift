...
class PlayerViewController: UIViewController {
    ...
    private var source: SourceDescription {
        ...
        if isClearStream {
            // Clear stream TypedSource declaration
            ...
            // DRM configuration
            let drmConfig = EzdrmDRMConfiguration(
                licenseAcquisitionURL: licenseUrl,
                certificateURL: certificateUrl
            )
            // DRM protected stream TypedSource declaration
            typedSource = TypedSource(
                src: videoUrl,
                type: mimeType,
                drm: drmConfig
    ...
    var mimeType: String = ""
    // Flag indicate if it is a clear stream
    var isClearStream: Bool = true
    // Licence URL for DRM protected stream
    var licenseUrl: String = ""
    // Certificate URL for DRM protected stream
