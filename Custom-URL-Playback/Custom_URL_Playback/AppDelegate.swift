...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        // Initailise StreamConfViewController
        let streamConfViewController = StreamConfViewController()
        // Create navigationController and set streamConfViewController as its root view controller
        let navigationController = createNavigationController(rootViewController: streamConfViewController)
